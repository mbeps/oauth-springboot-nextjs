 ...
 * <ul>
 * <li>Generating JWT tokens via {@link com.maruf.oauth.service.JwtService}</li>
 * <li>Setting HTTP cookie max-age values via {@link HttpCookieFactory}</li>
 * <li>Writing token expiration times to MongoDB via
 * {@link com.maruf.oauth.service.RefreshTokenStore}</li>
 * </ul>
 *
 * @author Maruf Bepary
 * @see com.maruf.oauth.service.JwtService
...
public class JwtSecurityProperties {
	 ...
	 * Used by:
	 * <ul>
	 * <li>{@link com.maruf.oauth.service.JwtService#buildToken(java.util.Map, String, long)}
	 ...
	 * Used by:
	 * <ul>
	 * <li>{@link com.maruf.oauth.service.JwtService#generateRefreshToken(String, java.util.Map)}
	 * to set the JWT {@code exp} claim</li>
	 * <li>{@link com.maruf.oauth.service.RefreshTokenStore#storeRefreshToken(String, String, java.time.Instant)}
