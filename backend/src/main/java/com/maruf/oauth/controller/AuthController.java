...
import com.maruf.oauth.config.CookieNames;
 ...
 * and transparent to the frontend via axios interceptor delegation.
 *
 * <p>
...
public class AuthController {
	 ...
	 * by the
	 * frontend to hydrate the {@code AuthContext} on application startup and after
	 * token refresh.
	 *
	 ...
	 *
	 * <p>
	 * Automatically called by the frontend's {@code apiClient} 401 interceptor when
	 * the
	 * access token has expired. Invoked by {@code authClient} (not
	 * {@code apiClient}).
	 *
	 * <p>
	 ...
	 * optional "local"
	 * provider if email/password authentication is enabled. The frontend uses this
	 * endpoint
