 ...
 * it difficult
 * to support multiple frontend origins (staging, production, local development)
 * from the same
 * backend.
 * <p>
...
public class CustomOAuth2AuthorizationRequestResolver implements OAuth2AuthorizationRequestResolver {
	 ...
	 *
	 * @param url URL to validate (typically a frontend base URL)
