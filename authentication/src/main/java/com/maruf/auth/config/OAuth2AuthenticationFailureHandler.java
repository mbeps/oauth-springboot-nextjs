 ...
 * user's browser
 * to the configured frontend URL with {@code ?error=auth_failed} query
 * parameter, allowing
 * the frontend to display a user-friendly error message.
 * <p>
...
public class OAuth2AuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {
	 ...
	 * <li>Redirects to the first allowed frontend URL from
	 * {@link AuthSecurityProperties#getAllowedRedirectUrls()}
	 * with {@code ?error=auth_failed} appended</li>
	 * </ol>
	 * <p>
	 * The frontend receives the error parameter and may display the appropriate
	 * message
